...
def GetPredictions(paramtype,ticker):
    ...
    data.tail()
    data_training = data[data['Date']<'2019-12-16 09:15:00+05:30'].copy()
    data_test = data[data['Date']>='2019-12-16 09:15:00+05:30'].copy()
    ...
    for i in range(20,len(y_pred)):
        d_pred.append(1940.35*y_pred[i]-1940.35*y_test[i-1])
        d_test.append(1940.35*y_test[i]-1940.35*y_test[i-1])
